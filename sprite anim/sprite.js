...
function sprite () {
    this.width = 2041; // ****el ancho todal de mi spritesheet***
    this.height = 370; // ***el alto de mi spritesheet ***
    this.x = 0;
    this.y = 0;
    this.radius = 330; //***esta medida es lo que mide el ancho de un sprite (un frame del spritesheet)***
    this.vx = 0;
    this.vy = 0;
    this.rotation = 0;
    this.scaleX = 1;
  ...
  sprite.prototype.draw = function (context) {
    ...
    marioImage.src = "Elec.png"; // ***el nombre de tu imagen***
    update();
    context.save();
